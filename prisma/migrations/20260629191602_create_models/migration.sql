...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Carvio Motors',
    "address" TEXT NOT NULL DEFAULT '69 Car Streen, Antelia',
    "phone" TEXT NOT NULL DEFAULT '+1 (555) 8379682',
    "email" TEXT NOT NULL DEFAULT 'contact@carvio.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
