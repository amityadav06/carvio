        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradiant-title">
              Find Your Dream Car with Carvio AI
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {bodyTypes.map((type) => {
              return (
                ...
                >
                  <div className="overflow-hidden rounded-lg flex justify-end relative h-28 mb-4">
                    <Image
                      src={type.image}
                      alt={type.name}
                      fill
                      sizes="20"
                      className="object-cover group-hover:scale-105 transistion duration-300"
                    />
                  </div>
      ...
      <section className="py-16 dotted-background text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thasounds of satisfied customers who found their perfect
